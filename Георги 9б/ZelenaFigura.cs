...
namespace ЗеленаПлощ
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("Въведете височината на вписания триъгълник: ");
            ...
            Console.WriteLine("Лицето на вписания триъгълник е: " + Triangle(a, h));
            ...
            double S3 = (BigRectangle(A, B) - ((LittleRectangle(a1, b1)) + (Triangle(a, h))));
